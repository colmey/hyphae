...
class Settings(BaseSettings):
    ...
    # Provider validation lives in hyphae.llm.client to keep this layer import-light.
    ...
    run_max_tokens: int = Field(
        ...
        description=(
            ...
            "(hyphae/agent/context.py) fills in, so the cap works against local "
