...
`hyphae/llm/providers/`) is responsible for two translations:
...
Provider registry:
  ...
  add a module or package in `hyphae/llm/providers/`, then add one entry here.
...
# hyphae/llm/providers/ + one entry here. Nothing else in the harness enumerates
